...
if archivo:
    ...
    df_prioridad = df_prioridad.dropna(subset=["Prioridad"])
        ...
        # Preparar stock con acumulación mensual (si hay columna 'MES')
    ...
    # 🔍 Validación de dimensiones antes de optimizar
    ...
    if resultado.success:
        ...
        # df_recomendaciones se generará más adelante solo si el usuario lo solicita
